      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex justify-center items-start gap-[90px] mt-[65px]">
            {/* Left section */}
            <motion.div
              className="flex flex-col items-end justify-between h-[290px] py-2"
            ...
            >
              <div className="flex w-[158px] flex-col items-end gap-2">
              ...
              <div className="flex w-[159px] flex-col items-end gap-2">
            ...
            {/* Right section */}
            <motion.div
              className="flex flex-col items-start justify-center h-[290px] py-2"
              variants={itemVariants}
              initial="hidden"
              animate="visible"
              exit="hidden"
